...
var lgasbystate = {
    ...
    Delta: [" ","Oshimili ", "Aniocha North", "Aniocha South", "Ika South", "Ika North-East", "Ndokwa West", "Ndokwa East", "Isoko south", "Isoko North", "Bomadi", "Burutu", "Ughelli South", "Ughelli North", "Ethiope West", "Ethiope East", "Sapele", "Okpe", "Warri North", "Warri South", "Uvwie", "Udu", "Warri Central", "Ukwani", "Oshimili North", "Patani"],
    Ebonyi: [" ","Afikpo South", "Afikpo North", "Onicha", "Ohaozara", "Abakaliki", "Ishielu", "lkwo", "Ezza", "Ezza South", "Ohaukwu", "Ebonyi", "Ivo"],
    Edo: [" ", "Esan North-East", "Esan Central", "Esan West", "Egor", "Ukpoba", "Central", "Etsako Central", "Igueben", "Oredo", "Ovia South-West", "Ovia South-East", "Orhionwon", "Uhunmwonde", "Etsako East", "Esan South-East", "Etsako West", "Ikpoba-Okha", "Ovia North-East"],
    ...
    Jigawa: [" ", "Auyo", "Babura", "Birnin Kudu", "Biriniwa", "Buji", "Dutse", "Gagarawa", "Garki", "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafin Hausa", "Kaugama", "Kazaure", "Kiri Kasamma", "Kiyawa", "Maigatari", "Malam Madri", "Miga", "Ringim", "Roni", "Sule-Tankarkar", "Taura", "Yankwashi"],
